module.exports = function (app) {
    ...
    findNowPlayingMovies = (req, res) =>
        fetch(constants.TMDB_BASE_URL +
            '/movie/now_playing?api_key=b4967ab0233cf05c29ceb49cf2f39c94')
            .then(movies => movies.json())
            .then(body => res.send(body));

    findUpcomingMovies = (req, res) =>
        fetch(constants.TMDB_BASE_URL +
            '/movie/upcoming?api_key=b4967ab0233cf05c29ceb49cf2f39c94')
            .then(movies => movies.json())
            .then(body => res.send(body));
    ...
    findPopularMovies = (req, res) =>
        fetch(constants.TMDB_BASE_URL +
            '/discover/movie?sort_by=popularity.desc&api_key=b4967ab0233cf05c29ceb49cf2f39c94')
            .then(movies => movies.json())
            .then(body => res.send(body));
    ...
    discoverMovies = (req, res) => {
        ...
        fetch(constants.TMDB_BASE_URL +
            '/discover/movie?sort_by=' + sortBy + '.' + order + '&api_key=b4967ab0233cf05c29ceb49cf2f39c94')
            .then(movies => movies.json())
            .then(body => res.send(body));
    }
    ...
    searchMovie = (req, res) =>
        fetch(constants.TMDB_BASE_URL +
            ...
            '&api_key=b4967ab0233cf05c29ceb49cf2f39c94')
